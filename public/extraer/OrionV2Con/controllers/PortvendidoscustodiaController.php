...
use app\models\PortVendidosCustodiaSearch;
...
/**
 * PortvendidoscustodiaController implements the CRUD actions for PortVendidosCustodia model.
 */
class PortvendidoscustodiaController extends Controller
{
    ...
    /**
     * Lists all PortVendidosCustodia models.
     * @return mixed
     */
   public function actionIndex()
    ...
    /**
     * Displays a single PortVendidosCustodia model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new PortVendidosCustodia model.
        ...
        public function actionCreate()
    {
        if(Yii::$app->request->isAjax){
            $model = new PortVendidosCustodia();
    ...
    /**
     * Updates an existing PortVendidosCustodia model.
 ...
 public function actionExit($id)
    ...
    /**
     * Deletes an existing PortVendidosCustodia model.
   ...
   public function actionDelete()
    ...
    /**
     * Finds the PortVendidosCustodia model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return PortVendidosCustodia the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = PortVendidosCustodia::findOne($id)) !== null) {
            return $model;
        } else {
    ...
    public function actionMostrar(){
        $searchModel = new PortVendidosCustodiaSearch();
    ...
    private function infoMetadata($tipo, $fecha = "", $comitente = "", $fech2 = "") {
        $arrInfo = [];       
         $arrInfo['cols'] = ['Emisor', 'Numeracion', 'Tipo', "Suma0" => 'ValorNominal','Observaciones'];
                $arrInfo['plantilla'] = 'plantilla/TitulosVendidosRegistradosEnCustodia.xlsx';
                $arrInfo['nombreExcel'] = 'tmp/TitulosVendidosRegistradosEnCustodia.xlsx';
                $arrInfo['nombrePdf'] = 'tmp/TitulosVendidosRegistradosEnCustodia.pdf';
                $arrInfo['inicio'] = 10;
                $arrInfo['colInicio'] = 2;
