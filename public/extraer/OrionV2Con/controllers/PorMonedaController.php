...
use app\models\PorMonedaSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * PorMonedaController implements the CRUD actions for PorGrupoInversion model.
 */
class PorMonedaController extends Controller
{
    ...
    {
        $searchModel = new PorMonedaSearch();
