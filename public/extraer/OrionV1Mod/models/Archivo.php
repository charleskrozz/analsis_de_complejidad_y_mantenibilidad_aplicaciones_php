...
{    
    ...
    public function rules()
    {
        return [
            ...
            [['usu_id', 'arc_tipo', 'com_id', 'por_id', 'arc_rep_id'], 'integer']
        ];
    }
    ...
    public function attributeLabels()
    {
        return [
            'arc_id' => 'Arc ID',
            'arc_nombre' => 'Nombre Archivo/Página',
            'arc_descripcion_corta' => 'Descripción Corta',
            'arc_descripcion_larga' => 'Descripción Larga',
            'arc_fecha' => 'Fecha',
            'usu_id' => 'Usuario',
            'arc_path' => 'Archivo/Página',
            'arc_imagen' => 'Imagen',
            'arc_original' => 'Archivo original',
            'arc_fecha_ingreso' => 'Fecha de ingreso',
